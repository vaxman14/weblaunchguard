  ...
  return (
    <LegalPage title="Terms of Service" updated="June 24, 2026" onBack={onBack}>
      ...
      <p>
        ...
        not constitute legal, security, or compliance advice. CTF Designs does not guarantee that the Service
        will detect all vulnerabilities or that any scan result is complete or accurate.
      </p>
      <p>
