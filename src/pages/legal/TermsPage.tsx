  ...
  return (
    <LegalPage title="Terms of Service" updated="June 24, 2026" onBack={onBack}>
      ...
      <p>
        ...
        not constitute legal, security, or compliance advice. CTFDigital does not guarantee that the Service
      ...
      <p>
        ...
        not intended for reliance by any other person. CTFDigital, its owner, and any affiliated companies
